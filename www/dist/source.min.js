...
angular.module("templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("suggestions_modal.html","<div class=\"modal\">\n  <header class=\"bar bar-header bar-positive\">\n    <h1 class=\"title\">{{ title }}</h1>\n    <div class=\"button button-clear\" ng-click=\"modal.hide()\"><span class=\"icon ion-ios-close-outline\"></span></div>\n  </header>\n\n  <ion-view>\n    <ion-content class=\"has-header\">\n\n      <ion-item class=\"item-input-inset\">\n        <label class=\"item-input-wrapper\">\n          <i class=\"icon ion-ios-search placeholder-icon\"></i>\n          <input id=\"search\" type=\"search\" placeholder=\"{{modal.title}}\" ng-change=\"search()\" ng-focus=\"scrollTop()\" ng-value=\"station.id\" ng-model=\"station.name\" autofocus />\n        </label>\n\n        <form name=\"search_form\" ng-submit=\"clearSearch()\">\n          <button class=\"button button-clear no-margin no-padding\" style=\"text-align: right;\" ng-click=\"clear()\">\n            <i class=\"icon ion-android-cancel\"></i>\n          </button>\n        </form>\n      </ion-item>\n\n      <ion-item class=\"item-divider\" ng-if=\"!suggestions && suggestions_favorites.length\">\n        Favorites\n      </ion-item>\n\n      <div class=\"list no-margin no-padding\" ng-if=\"!suggestions && suggestions_favorites.length\">\n        <li class=\"item\" ng-repeat=\"favorite in suggestions_favorites\" ng-click=\"onSelect(favorite)\">\n          <i class= \"icon ion-star energized\"></i>\n          {{favorite.name}}\n        </li>\n      </div>\n\n      <div class=\"list no-margin no-padding\" ng-if=\"suggestions\">\n        <li class=\"item\" ng-repeat=\"suggestion in suggestions\" ng-click=\"onSelect(suggestion)\">\n          {{suggestion.name}}\n        </li>\n      </div>\n\n    </ion-content>\n  </ion-view>\n</div>\n");
$templateCache.put("tab-connections.html","<ion-view view-title=\"Connections\">\n  <ion-content>\n    <ion-list>\n      <div class=\"\">\n        <ion-item class=\"item item-divider item-icon-left\">\n          <i class=\"icon ion-clock\"></i>\n          Nürnberg\n          <p>{{ date }} {{ time }}</p>\n        </ion-item>\n\n        <ion-item class=\"item item-input padding\" placeholder=\"From\" ng-click=\"openModal(\'sl\')\" ng-value=\"sl.id\" ng-model=\"sl.name\">\n          <i class=\"icon ion-log-in placeholder-icon\"></i>\n          {{sl.name}}\n        </ion-item>\n\n        <i class=\"icon icon-swap ion-arrow-swap\" ng-click=\"swap()\" toggle-class=\"active\"></i>\n\n        <ion-item class=\"item item-input padding\" placeholder=\"From\" ng-click=\"openModal(\'zl\')\" ng-value=\"zl.id\" ng-model=\"zl.name\">\n          <i class=\"icon ion-log-out placeholder-icon\"></i>\n          {{zl.name}}\n        </ion-item>\n      </div>\n\n      <div class=\"list\" ng-if=\"connections\">\n        <ion-item class=\"item list-inset\" ng-repeat=\"connection in connections\">\n          <div class=\"row no-padding\">\n            <div class=\"col col-50 no-padding\">\n              <b class=\"bold\">{{connection.departure()}}-{{connection.arrival()}}</b>\n            </div>\n            <div class=\"col col-50 no-padding text-right\">\n              <span class=\"item-multi item-transport-small {{transport.transport}} {{transport.line}}\" ng-repeat=\"transport in connection.transports\" >\n                {{transport.line}}\n              </span>\n            </div>\n          </div>\n\n          <p>{{connection.info}}</p>\n        </ion-item>\n      </div>\n\n      <div class=\"button-bar padding\" ng-if=\"connections.length\">\n        <a class=\"button\" ng-click=\"loadMore()\">\n          Load more ...\n        </a>\n      </div>\n\n    </ion-list>\n  </ion-content>\n</ion-view>\n");
